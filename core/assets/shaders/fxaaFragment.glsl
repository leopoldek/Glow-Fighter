//From https://github.com/manuelbua/libgdx-contribs/blob/master/postprocessing/src/main/resources/shaders/fxaa.fragment
...
void main() {
	gl_FragColor = fxaa(u_texture, v_texCoords, 1.0 / textureSize(u_texture, 0));
}